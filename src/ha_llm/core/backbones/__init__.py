...
Swap via `model.arch` or `build_backbone`. Stacks are in `ha_llm.core.transformers`
so a VLM can reuse GPTStack / LGTStack / DiTStack with its own embeddings.
"""

from ha_llm.core.backbones.dit import DiTBackbone
from ha_llm.core.backbones.factory import BACKBONES, backbone_kwargs, build_backbone, register_backbone
from ha_llm.core.backbones.gpt import GPTBackbone, TransformerBackbone
